...
**Note:** Please build the app in Kotlin, follow the standard software development process, and design your own UI/UX to achieve the above requirements.  
If any of the requirements cannot be implemented, you may provide research findings as an alternative.
